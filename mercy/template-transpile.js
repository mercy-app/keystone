...
const template = {
  ...
  client: [
    ...
    {
      id: 2,
      image: '../../assets/image/appModern/company2.png',
      title: 'amazon',
    },
    {
      id: 3,
      image: '../../assets/image/appModern/company3.png',
      title: 'evernote',
    },
    {
      id: 4,
  ...
  appSlider: {
    carousel: [
      {
        id: 1,
        image: '../../assets/image/appModern/appSlider1.png',
        title: 'App Slide 1',
      },
      {
        id: 2,
        image: '../../assets/image/appModern/appSlider2.png',
        title: 'App Slide 1',
      },
      {
        id: 3,
        image: '../../assets/image/appModern/appSlider3.png',
        title: 'App Slide 1',
      },
    ],
  ...
  teamportfolio: {
    ...
    teammember: [
      {
        id: 1,
        img: '../../assets/image/appModern/1.png',
        text: 'Berlin Corleone',
      },
      {
        id: 2,
        img: '../../assets/image/appModern/2.png',
        text: 'Jona White',
      },
      {
        id: 3,
        img: '../../assets/image/appModern/3.png',
        text: 'Michael Price',
      },
      {
        id: 4,
        img: '../../assets/image/appModern/4.png',
        text: 'Vito Jackson',
      },
      {
        id: 5,
        img: '../../assets/image/appModern/5.png',
        text: 'Miss Clair',
      },
      {
        id: 6,
        img: '../../assets/image/appModern/6.png',
        text: 'Kabir Ali',
      },
      {
        id: 7,
        img: '../../assets/image/appModern/7.png',
        text: 'Arthus Doe',
      },
    ],
  },
  ...
  for (let index = 0; index < array.length; index++) {
    ...
    for (const key in element) {
      ...
      if (Array.isArray(element[key])) {
        ...
        block[key] = element[key];
      }
    }
    blocks.create.push(block);
  }
  return blocks;
}

function tranpileTemplateToDb() {
  const data = {
    sections: {
      create: [],
    },
  ...
  for (const section in template) {
    if (Array.isArray(template[section])) {
      ...
      //    section: []
      // }
      const blocks = checkBlocks(template[section]);
      data.sections.create.push({
        template: 'appModern',
        type: section,
        lists: {
          create: [
    ...
    } else if (typeof template[section] === 'object') {
      // {
      //    section: {
      //      lists: []
      //    }
      ...
      for (const field in template[section]) {
        if (Array.isArray(template[section][field])) {
          const blocks = checkBlocks(template[section][field]);
          const list = {
            name: field,
            blocks,
          };
          lists.create.push(list);
        } else {
          newSection[field] = template[section][field];
        }
        sectionSet.add(field);
      }
      data.sections.create.push({
        ...newSection,
        lists,
