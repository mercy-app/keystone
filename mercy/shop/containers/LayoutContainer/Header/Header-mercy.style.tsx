...
export const DrawerMenuItem = styled.div`
	...
	.drawer_menu_item {
		...
		background: -webkit-linear-gradient(110deg, ${props => props.color0} 60%, ${props =>
  props.color1} 60%);
  	background: -o-linear-gradient(110deg, ${props => props.color0} 60%, ${props =>
  props.color1} 60%);
  	background: -moz-linear-gradient(110deg, ${props => props.color0} 60%, ${props =>
  props.color1} 60%);
  	background: linear-gradient(110deg, ${props => props.color0} 60%, ${props => props.color1} 60%);
